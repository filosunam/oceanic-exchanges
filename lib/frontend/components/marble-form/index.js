...
class EmailWidget extends Component {
  render() {
    ...
    const classNameControl = classNames("control", {
      "is-tooltip tooltip": this.props.tooltip
    });
...
class MarbleForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // Error handlers
      handleMessages:
        props.handleMessages === undefined ? true : props.handleMessages,
      defaultSuccessMessage:
        props.defaultSuccessMessage || "Data correctly processed",
  ...
  componentWillReceiveProps(props) {
    ...
    const successMessage =
      "successMessage" in props
        ? props.successMessage
        : this.props.successMessage;
    const errorMessage =
      "errorMessage" in props ? props.errorMessage : this.props.errorMessage;
  ...
  render() {
    ...
    if (!formActions) {
      const className = classNames(
        buttonClassName || "button is-primary is-fullwidth",
        {
          "is-loading": loading
        }
      );
    ...
    return (
      <form className={formClass} onSubmit={e => this.onSubmitHandler(e)}>
        {widgets}
        {errorMessage}
        {successMessage}
        {formActions}
