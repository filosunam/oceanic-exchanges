          ...
          <div className="section">
            <div className="columns">
              <div className="column">
                <div className="card">
                  <header className="card-header">
                    <p className="card-header-title">Form Builder</p>
                  </header>
              ...
              <div className="column">
                <div className="card">
                  <header className="card-header">
                    <p className="card-header-title">Form Schema</p>
                    <div className="tabs">
                      <ul>
                        <li
                          onClick={() => this.setCurrentDisplay("form")}
                          className={
                            currentDisplay === "form" ? "is-active" : ""
                          }
                        >
                          <a>Form</a>
                        </li>
                        <li
                          onClick={() => this.setCurrentDisplay("schema")}
                          className={
                            currentDisplay === "schema" ? "is-active" : ""
                          }
                        >
                          <a>Schema</a>
                        </li>
